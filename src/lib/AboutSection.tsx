...
export default function AboutSection() {
  return (
    <section id="about" className="min-vh-100 d-flex align-items-center justify-content-center text-center position-relative overflow-hidden section-2">

      <div className="container px-4 px-lg-5">
        <FadeIn direction="up">
          <div className="text-center mb-5">
            <h2 className="display-4 fw-bold text-light mb-3">Who is Conrad</h2>
            <div
              className="mx-auto bg-info"
              style={{ width: '6rem', height: '0.25rem' }}
            ></div>
            <p
              className="lead text-info mt-4 mx-auto"
              style={{ width: '100%', whiteSpace: 'nowrap', overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}
            >
              A professional software engineer with a passion for building fundamentally secure, high performance applications.
            </p>
            <p
              className="lead text-info mt-4 mx-auto"
              style={{ width: '100%', whiteSpace: 'nowrap', overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}
            >
              With expertise spanning multiple languages and frameworks, I bring a security-first approach to every project.
            </p>
          </div>
        </FadeIn>
          ...
          <div className="bg-dark text-white rounded-4 p-4 p-md-5">
            ...
            <div className="row g-4">
              <div className="col-md-6">
                <h4 className="h5 text-info fw-bold mb-3">Problems I Solved</h4>
                <ul className="list-unstyled text-secondary">
                  <li className="mb-2 d-flex align-items-start">
                    <span className="text-info me-2">•</span>
                    <span>
                      Building secure authentication systems for healthcare applications
                    </span>
                  </li>
                  <li className="mb-2 d-flex align-items-start">
                    <span className="text-info me-2">•</span>
              ...
              <div className="col-md-6">
                ...
                <ul className="list-unstyled text-secondary">
                  ...
                  <li className="mb-2 d-flex align-items-start">
                    <span className="text-info me-2">•</span>
                    <span>Cloud-native applications reduce operational costs</span>
                  </li>
                  <li className="mb-2 d-flex align-items-start">
                    <span className="text-info me-2">•</span>
                    <span>End-to-end ownership improves throughput</span>
                  </li>
                </ul>
              </div>
            </div>
