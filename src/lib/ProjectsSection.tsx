import { ExternalLink, Code2, TreePalm, Tv, BuildingIcon, RocketIcon } from 'lucide-react';
...
const featuredProject = {
  ...
  highlights: [
    'Built a platform to assist in reducing depression using AI-driven assistants, mood tracking, and personalized resources',
  ...
  github: 'https://github.com/elconrad23/Obeeoma.git',
...
export default function ProjectsSection() {
  return (
    <section id="projects" className="py-5 position-relative section-4">
      <div className="container px-4 px-lg-5">
        <FadeIn direction="up">
          <div className="text-center mb-5">
            ...
            >
              Experience in full-stack development Projects with cloud-native architectures, and security-first approaches.
            </p>
          </div>
        </FadeIn>
